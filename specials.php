<?php
 $title = 'Latest Specials Sales and Promotions'
?> 
<?php
   include("header.php"); ?>
<body>
...
<h2 class="featurette-heading">Specials: <span class="text-muted">View our latest offers!</span></h2>
<hr>
...
$query_products = "SELECT *FROM products WHERE active =1 AND  special = 1". " ORDER BY name" ;
