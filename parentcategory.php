...
<h1 class="featurette-heading"><?php echo $_GET['t'];?></h1>

      	<div class="products col-md-9 col-sm-8">
     			<?php 
			mysql_select_db($database_sql, $sql);
$query_category = "SELECT id, title, image FROM category WHERE parentName = '" .  $_GET['t'] ."' ORDER BY title ASC";
...
?>
      ...
      <a class="thumbnail" href="category.php?t=<?php echo $row_category['title']?>">
